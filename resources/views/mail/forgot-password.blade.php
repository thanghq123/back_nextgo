        ...
        <tr>
            <td align="center" valign="center" style="text-align:center; padding: 40px">
                <a href="{{env('APP_URL')}}" rel="noopener" target="_blank">
                    <img alt="Logo" src="{{ $message->embed(public_path('/assets/media/logos/mail.svg'))}}"/>
                </a>
            </td>
        </tr>
        <tr>
            <td align="left" valign="center">
                <div
                    ...
                    <div style="padding-bottom: 30px">You are receiving this email because we received a password reset
                        request for your account. To proceed with the password reset please click on the button below:
                    </div>
                    <div style="padding-bottom: 40px; text-align:center;">
                        <a href="{{env('APP_URL')}}reset-password/{{$mailData['token']}}/{{$mailData['email']}}" rel="noopener"
                    ...
                    <div style="padding-bottom: 30px">This password reset link will expire in 60 minutes. If you did not
                    ...
                    <div style="padding-bottom: 50px; word-wrap: break-all;">
                        ...
                        <a href="{{env('APP_URL')}}reset-password/{{$mailData['token']}}/{{$mailData['email']}}" rel="noopener"
                           target="_blank" style="text-decoration:none;color: #009ef7">{{env('APP_URL')}}reset-password/{{$mailData['token']}}/{{$mailData['email']}}</a>
                    </div>
                    <!--end:Email content-->
                    <div style="padding-bottom: 10px">Kind regards,
                        ...
                        <tr>
                            <td align="center" valign="center"
                                ...
                                <p>Copyright &copy;
                                    <a href="{{env('APP_URL')}}" rel="noopener" target="_blank">FullSnack Team</a>.</p>
                            </td>
                        </tr>
                        </br></div>
                </div>
